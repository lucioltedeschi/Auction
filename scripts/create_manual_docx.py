...
flow(doc, "4. Catálogo, puja y varios artículos", "Cliente comprador", "Ofertar por más de un lote y visualizar cada participación.",
     ...
     ["Abrir una subasta disponible.", "Recorrer todos los lotes; solo el actual debe mostrar PUJAR AHORA y los próximos, ESPERANDO TURNO.", "Pujar por el lote activo y esperar confirmación del servidor.", "Esperar que el siguiente lote quede activo antes de ofertar por él.", "Comprobar que mejor oferta y liderazgo cambian solos en dos teléfonos.", "Abrir Historial y verificar dos fichas independientes actualizadas automáticamente.", "Tocar cada ficha para volver a su subasta."],
     ["Nunca hay dos lotes habilitados para pujar al mismo tiempo.", "Cada participación conserva oferta propia, mejor actual y estado GANADO/LIDERANDO/SUPERADA.", "SSE actualiza la subasta cada 2 s y se reconecta si se corta la red.", "La puja genera un aviso y nunca reemplaza a otra participación."],
     ["Tocar ESPERANDO TURNO: debe explicar que solo se oferta por el lote activo.", "Forzar por API una puja a un lote futuro: HTTP 409 sin insertar.", "Probar menos de mejor oferta + 1% de base: rechazo.", "Probar más de mejor oferta + 20% de base en categorías no premium: rechazo.", "Entrar a otra subasta sin haber ofertado: debe permitir confirmar el cambio.", "Intentar cambiar luego de pujar: debe conservar el vínculo y explicar el motivo."])
